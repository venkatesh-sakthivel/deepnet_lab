...
def configure():
	...
	# data
	flags.DEFINE_string('data_dir', './dataset', 'data directory')
	flags.DEFINE_integer('batch_size', 10, 'training batch size')
	flags.DEFINE_integer('input_height', 500, 'input image height')
	flags.DEFINE_integer('input_width', 393, 'input image width')
